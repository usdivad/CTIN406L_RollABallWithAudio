...
This is for OSX Intel machines and Unity v. 2019 (and earlier).
All versions work for Windows 10/Windows 11.
...
uses the associated simple "beep.cs" script to do this.  Drag the "beep"
prefab into your scene for it to work.
